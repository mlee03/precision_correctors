...
contains
  ...
  subroutine init(self, name, dims)
    class(Field32), intent(inout) :: self
  ...
  pure subroutine assign_array(self, a)
    class(Field32), intent(in out) :: self
  ...
  pure function diffx(input_field)
    ...
    class(Field32), intent(in) :: input_field
  ...
  pure type(Field32) function field_add_field(self, f) result(res)
    class(Field32), intent(in) :: self, f
    res = self
    res = self % data + f % data
  end function field_add_field

  pure type(Field32) function field_add_real(self, x) result(res)
    class(Field32), intent(in) :: self
  ...
  pure type(Field32) function real_add_field(x, self) result(res)
    class(Field32), intent(in) :: self
    real(real32), intent(in) :: x(:,:)
    res = self
    res = self % data + x
  ...
  pure type(Field32) function field_div_real(self, x) result(res)
    class(Field32), intent(in) :: self
    real(real32), intent(in) :: x
    res = self
    res = self % data / x
  ...
  pure type(Field32) function field_mult_array(self, x) result(res)
    class(Field32), intent(in) :: self
    real(real32), intent(in) :: x(:,:)
    res = self
    res = self % data * x
  ...
  pure type(Field32) function field_mult_real(self, x) result(res)
    class(Field32), intent(in) :: self
    real(real32), intent(in) :: x
    res = self
    res = self % data * x
  ...
  pure type(Field32) function field_mult_field(self, f) result(res)
    class(Field32), intent(in) :: self, f
    res = self
    res = self % data * f % data
  end function field_mult_field

  pure type(Field32) function array_mult_field(x, self) result(res)
    real(real32), intent(in) :: x(:,:)
    class(Field32), intent(in) :: self
    res = self
    res = self % data * x
  ...
  pure type(Field32) function field_sub_array(self, x) result(res)
    class(Field32), intent(in) :: self
    real(real32), intent(in) :: x(:,:)
    res = self
    res = self % data - x
  ...
  pure type(Field32) function field_sub_field(self, f) result(res)
    class(Field32), intent(in) :: self, f
    res = self
    res = self % data - f % data
